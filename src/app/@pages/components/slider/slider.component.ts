...
export class pgSliderComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
  ...
  createDrag(): void {
    ...
    } as { start: string, move: string, end: string, pluckKey: string[], filter(e: Event): boolean, startPlucked$: Observable<any>, end$: Observable<any>, moveResolved$: Observable<any> } ;
    const touch = {
