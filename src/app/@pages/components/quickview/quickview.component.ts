...
export class QuickviewComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscriptions.push(this._service.getNotes().subscribe(res => {
      this.noteList = res['notes'];
    }));

    this.subscriptions.push(this._service.getUsers().subscribe(res => {
      this.userList = res['users'];
    }));

    this.subscriptions.push(this._service.getChatMessages().subscribe(res => {
